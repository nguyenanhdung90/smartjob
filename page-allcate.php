...
<div class="wrapper clearfix">
	<div class="heading">
		<div class="main-center">
			<h1 id="job_title" class="title job-title">Blog</h1>
		</div>
	</div>
	<div class="main-center">
...
<?php endif; ?>						
			...
			<aside class="widget widget_miw_multi_image_widget" id="miw_multi_image_widget-4"><div class="widget-title" style="margin-top: 12px; font-weight: 500; font-size: 21px;"> Chuyên mục Smartjob</div>         
