...
<div data-role="content" id="page" class="ui-home resume-content-home" style="background-color:white">
	<ul class="listview" data-role="listview" id="job-content" style="box-shadow:none">
		<?php
		if ( have_posts() ) {
	...
	?>
		...
		<div class="outblog_mobile" >
			<div class="tieude_mobile_outblog" style="">
				<a href="http://smartjob.vn/all-blog/">Our blog</a>
			</div>
			<?php 
			$args = array(
			'post_type' => 'post',
