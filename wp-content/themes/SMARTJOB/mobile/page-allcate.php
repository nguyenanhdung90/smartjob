...
<div data-role="content" class="resume-contentpage" style="margin-bottom:0px">
	<h1 class="title-resume" style="font-size:25px">Lastest our blogs</h1>
...
<?php endif; ?>					
	...
	<div style="overflow:hidden;background-color:white">
	    <div style="font-size: 24px;font-weight: 500;text-align: center;padding-bottom: 17px;padding-top: 12px;"><a href="http://smartjob.vn/all-blog" style="text-decoration: none;">Our blog:</a></div>
		 <?php 
		$args2 = array(
			'type'                     => 'post',
