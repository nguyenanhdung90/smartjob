...
class ET_JobEngineMailTemplate extends ET_Options 
{
	...
	public function __construct() {
		...
		$this->opt_keys	=	array (
			...
			'et_apply_mail_editor'			=>	 __("Apply-for-job Email template editor",ET_DOMAIN),
	...
	function reset_mail_template ( $mail) {
		...
		switch ($mail) {
			...
			case 'et_apply_mail_editor':
				return $this->set_apply_mail_editor( $new_value, true );
	...
	/**
	 * get apply job mail template editor, this mail will be send to companies when 
	 * a job seeker apply their jobs
	 */
	public function get_apply_mail_editor ( ) {
		$default	=	__("<p>Dear [display_name_editor],</p><p>Your job offer for [job_title] posted in [blogname] has a new application.</p><p>Here are the applicant's information:</p><ol><li>Name: &nbsp;[seeker_name]</li><li>Email address: [seeker_mail]</li><li>Note: [seeker_note]</li></ol><p>The files of the applicant are also attached in this email.</p><p>And here is the link to your job offer: [job_link].</p><p>Sincerely,<br />[blogname]</p>", ET_DOMAIN);
		return stripslashes(( $this->get_option('et_apply_mail_editor', $default) ));
	}
	/**
	 * set apply job mail template editor
	 * @param $new_value : string new mail template value
	 * @param $default : bool if true, mail template will be reset to default
	 */
	public function set_apply_mail_editor ( $new_value, $default ) {
		if($default) {
			$new_value	=	__("<p>Dear [display_name_editor],</p><p>Your job offer for [job_title] posted in [blogname] has a new application.</p><p>Here are the applicant's information:</p><ol><li>Name: &nbsp;[seeker_name]</li><li>Email address: [seeker_mail]</li><li>Note: [seeker_note]</li></ol><p>The files of the applicant are also attached in this email.</p><p>And here is the link to your job offer: [job_link].</p><p>Sincerely,<br />[blogname]</p>", ET_DOMAIN);
		}
		$this->update_option('et_apply_mail_editor', $new_value);
		return $new_value;
	}
	/**
