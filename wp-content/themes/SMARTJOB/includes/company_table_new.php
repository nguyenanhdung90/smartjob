...
{	
	if(!isset($_GET['gate']))
	{
		if(isset($_POST['publish_company']))
		{
			...
			elseif($_POST['mail_compan']==""){
				$mail_company_error="Địa chỉ mail bị lỗi";
			}
			elseif($_POST['url_com']==""){
				$url_company_error="Địa chỉ trang web bị lỗi";
			}
			else
			{
				if (!filter_var($_POST['mail_compan'], FILTER_VALIDATE_EMAIL)) {
					$mail_company_error="Địa chỉ mail bị lỗi";
				}elseif (filter_var($_POST['url_com'], FILTER_VALIDATE_URL) === false)
				{
					$url_company_error="Địa chỉ trang web bị lỗi";
				}
				else
								...
								<div id="et_job" class="postbox " >
									...
									<div class="inside">
										...
										<p>
											...
											<input type="text" id="et_location" name="mail_compan" class="et-field" placeholder="<?php if(isset($mail_company_error))echo $mail_company_error; ?>" value="<?php if(isset($mail_company))echo $mail_company;?>">
										</p>		
										<p>
											<label for=""><strong>Company Website</strong></label> <br>
											<input type="text" name="url_com" class="et-field" placeholder="<?php if(isset($url_company_error))echo $url_company_error; ?>"  value="<?php if(isset($Website_company))echo $Website_company;?>"> <br>
										</p>										
										<p>
