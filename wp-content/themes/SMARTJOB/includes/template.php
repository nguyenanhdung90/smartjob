...
function et_template_frontend_job(){
	...
	<div class='content'>
		...
		<div class='desc f-left-all' style="top:57px">
			...
			<div><span class="ob-location" itemtype="" itemscope="" itemprop="jobLocation"><span class='icon' >{{mucluong}}:</span><span class='job-location' style="color:#F0111B">{{ money_mucluong}}</span></span></div>
		</div>
...
function et_template_frontend_job_author(){
	$strings = array(
			'edit' 		=> __('Edit', ET_DOMAIN),
			'featured' 	=> __('Hot', ET_DOMAIN),
			'approve' 	=> __('Approve', ET_DOMAIN),
